...
echo "<table align=center class=myTable-gray width=50%>";

echo "<tr><td class=titulo colspan=4>FICHA VEHICULAR</td></tr>";
echo "<tr><td colspan=4 align=left class=subtitulo><b>Datos del Vehiculo:</b></td></tr>";
...
echo "<tr><td>";
echo "<table align=center class=myTable-gray width=50%>";
echo "<tr><td colspan=4 align=left class=subtitulo><b>DETALLE TECNICO:</b></td></tr>";
echo "<tr></tr><tr></tr><tr></tr>";
echo "<table align=center class=myTable-gray width=50%>";
echo "<tr>";
t_data("<b>FECHA</b>", "");
