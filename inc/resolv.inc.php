...
if (isset($_GET["event"])) {	//GET
	...
	switch ($_GET["event"]) {
		...
		case "menu_fich":
			include("inc/ficha/menu_fich.php");
			break;
		case "busq_add":
			include("inc/ficha/busq_add.php");
			break;
		case "busq_verif":
			include("inc/ficha/busq_verif.php");
			break;
		case "sel_car":
		...
		case "current_account":
			include("inc/currentaccount/menu_cta.php");
			break;
		case "busq_cta":
			include("inc/currentaccount/busq_add.php");
			break;
		case "busq_estado":
			include("inc/currentaccount/busq_estado.php");
			break;
		case "sel_client":
